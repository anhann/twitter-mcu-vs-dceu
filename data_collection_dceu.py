# -*- coding: utf-8 -*-
"""Data Collection - DCEU.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1swD8WcxCa4Z4IToeSIK0nTqRTwtJvCoR
"""
...
while i<1000:
    ...
    try:
        ...
        for tweet in tweet_stream:
            ...
            log.append(tweet)
            print(tweet["text"])
    #if the loop stop convert current log and save to csv from DC1,DC2...
    except KeyError:
        df=pd.DataFrame(log)
        df.to_csv('DC'+str(i)+'.csv')
        i+=1
        continue
